...
<div class="mobile-overlay" id="mobileOverlay" role="dialog" aria-modal="true" aria-label="Menu de navegação">
  ...
  <div class="mobile-panel" id="mobilePanel">
    <div class="mobile-panel__head">
      <img src="/assets/images/logo-allaser.webp" alt="Allaser" class="mobile-panel__logo" width="200" height="59">
    ...
    <div class="footer__grid">
      <div>
        <div class="footer__brand-logo">
          <img src="/assets/images/logo-allaser.webp" alt="Allaser" width="200" height="59">
        </div>
...
`;
  ...
  var LOGIN_MODAL_HTML = ''
    ...
    +       '</div>'
    +       '<div class="hdr-login-forgot"><a href="https://cursos.allaser.com.br/aluno/forgot" target="_blank" rel="noopener">Esqueci minha senha</a></div>'
  ...
  var LOGIN_MODAL_CSS = ''
    ...
    + '.hdr-login-forgot{text-align:right;margin:-6px 0 14px}'
    + '.hdr-login-forgot a{font-size:.82rem;color:#8fa030;text-decoration:none;font-weight:600;transition:color .15s}'
    + '.hdr-login-forgot a:hover{color:#0e1418;text-decoration:underline}'
