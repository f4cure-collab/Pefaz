...
| ✅ | LP Start Laser Presencial POA | `lps/cursos/start-laser-poa.html` | Criada 2026-07-28 baseada na LP WP `curso-laserterapia-para-profissionais-da-saude/`. Presencial em Porto Alegre. CTA único → Eduzz `chk.eduzz.com/39YN53ADWO`. 4 lotes com bônus diferenciado: Lote 1 (5v, livro ILIB) · Lote 2 (15v, hands on 26/09-11/11-11/12) · Lote 3 (20v, masterclass à escolha) · Lote 4 (sem bônus). Imagens do WP baixadas e otimizadas para `/assets/images/lps/start-laser-poa/` — autônoma do WP. |
