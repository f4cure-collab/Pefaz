...
- **`cursos-data.js` tem 29 entradas** — todos com capa 9:16 em `/assets/images/capas-cursos/`. (Curso Laserpuntura removido em 2026-07-23 a pedido: banner + LP + capa + entrada no JSON. Posts do blog sobre a técnica ficaram.) Cursos sem capa (presenciais com data específica, fóruns gravados, materiais avulsos, plantão start-laser, combos ocultos, avançados) foram removidos em 2026-06-26 quando padronizamos o pôster 9:16. Se precisar reativar algum, providencie a capa antes de re-adicionar no `cursos-data.js`.
